...
class NoteEndToEndTest {
    ...
    fun saveNewNote_editAfterwards() {
        // Click on Fab to get to add node screen
        ...
        // Make sure there is an note in the list with our title and content
        composeRule.onNodeWithText("test-title").assertIsDisplayed()
        // Click on a note to edit it
        composeRule.onNodeWithText("test-title").performClick()

        // Make sure that title and content text fields contain note title and content
        composeRule
            .onNodeWithTag(TestTags.TITLE_TEXT_FIELD)
